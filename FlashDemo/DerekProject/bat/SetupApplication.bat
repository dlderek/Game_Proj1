...
:: Android packaging
set AND_CERT_NAME="DerekProject"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\DerekProject.p12
...
set IOS_PROVISION=cert\DerekProject.mobileprovision
...
set APP_ID=air.DerekProject

:: Output packages
set DIST_PATH=dist
set DIST_NAME=DerekProject
